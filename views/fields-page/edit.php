<div class="wrap">
    <h1 class="wp-heading-inline">
        <?php echo esc_html__( 'Update fields', 'weasyfields' ); ?>
    </h1>
    ...
    <form id="weasyfields-fields-form" data-null-msg="<?php echo esc_attr__( 'Please add a field on the right.', 'weasyfields' ); ?>" action="<?php echo esc_url( $this->url ); ?>&action=edit&id=<?php echo esc_attr( $_GET['id'] ); ?>" class="weasyfields-form-space" method="post">
        ...
        <div id="poststuff">
            <div id="post-body" class="metabox-holder columns-2">
                ...
                <div id="post-body-content">
                    <div id="titlediv">
                        <div id="titlewrap">
                            <input type="text" name="title" size="30" id="title" class="weasyfields-input-null-dedector" spellcheck="true" autocomplete="off" placeholder="<?php echo esc_html__( 'Add title', 'weasyfields' ); ?>" value="<?php echo esc_html( $title ); ?>">
                        </div>
                    </div>
                ...
                <div id="postbox-container-1" class="postbox-container">
                    ...
                    <div class="postbox">
                        <div class="postbox-header">
                            <h2><?php echo esc_html__( 'Update fields', 'weasyfields' ); ?></h2>
                        </div>
                        <div class="inside">
                            <div class="minor-publishing">
                                ...
                                <select name="type" data-option="<?php echo esc_attr( $type ); ?>" class="widefat weasyfields-select-option-value">
                                ...
                                <p class="post-attributes-label-wrapper page-template-label-wrapper">
                                    <label class="post-attributes-label">
                                        <?php echo esc_html__( 'Fields status', 'weasyfields' ); ?>
                                    </label>
                                </p>
                                <select name="status" data-option="<?php echo esc_attr( $status ); ?>" class="widefat weasyfields-select-option-value">
                                    <option value="publish">
                                        <?php echo esc_html__( 'Publish', 'weasyfields' ); ?>
                                    </option>
                                    <option value="unpublish">
                                        <?php echo esc_html__( 'Unpublish', 'weasyfields' ); ?>
                                    </option>
                                </select>
                                <!-- weasyfields-fields-type -->
                                ...
                                <div class="minor-publishing-actions" style="padding:10px 0 0 0">
                                    ...
                                    <a href="<?php echo esc_url( $this->url ); ?>&action=delete&id=<?php echo esc_attr( $id ); ?>" class="weasyfields-delete-fields"><?php echo esc_html__( 'Delete fields', 'weasyfields' ); ?></a>
                            ...
                            <ul class="fields sortable ui-sortable" id="weasyfields-field-list">
                                <?php
                                    foreach ( $fields as $index => $field ) {
                                        $this->view_i( "fields/" . $field['field_key'], array( 'field' => $field ) );
                                    }
                                ?>
                            </ul><!-- .fields -->
                        </div><!-- .inside -->
